...
class StickFigureSprite(Sprite):
    def __init__(self, game):
        Sprite.__init__(self, game)
        self.images_left = [PhotoImage('1.gif'), PhotoImage('2r.gif'), PhotoImage('3r.gif')]
        self.images_right = [PhotoImage('1.gif'), PhotoImage('2.gif'), PhotoImage('3.gif')]
        self.image = game.canvas.create_image(200, 400, 70, image=self.images_left[0], anchor='nw')
        self.x = -2
        self.y = 0
...
g = Game()
platform = PlatformSprite(g, PhotoImage('30px.gif'), 0, 480, 100, 10)
platform1 = PlatformSprite(g, PhotoImage('60px.gif'), 150, 400, 40, 110)
platform2 = PlatformSprite(g, PhotoImage('90px.gif'), 300, 400, 100, 10)
